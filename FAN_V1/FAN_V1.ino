...
void checkDeviceStatus() {
  ...
  if (httpResponseCode > 0) {
    ...
    // Accessing and converting the FanSpeed field to integer
    int setFanSpeed = doc["fields"]["setFanSpeed"]["integerValue"].as<int>();
    Serial.println("Fan Speed: " + String(setFanSpeed));
    switch (setFanSpeed) {
        case 0:
